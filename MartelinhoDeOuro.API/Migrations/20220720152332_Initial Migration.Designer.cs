...
namespace MartelinhoDeOuro.API.Migrations
{
    ...
    [Migration("20220720152332_Initial Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MartelinhoDeOuro.API.Models.Endereco", b =>
                {
                    b.HasOne("MartelinhoDeOuro.API.Models.Proprietario", null)
                        .WithOne("Endereco")
            ...
            modelBuilder.Entity("MartelinhoDeOuro.API.Models.Veiculo", b =>
                {
                    b.HasOne("MartelinhoDeOuro.API.Models.Proprietario", null)
                        .WithOne("Veiculos")
                        .HasForeignKey("MartelinhoDeOuro.API.Models.Veiculo", "ProprietarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
